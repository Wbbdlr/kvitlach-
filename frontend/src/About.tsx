...
export default function About() {
  return (
    <PageShell active="/about">
      <h1 className="font-display text-3xl text-amber-800">About Kvitlach</h1>


      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">What is this?</h2>
        <p>
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">How to play (quick start)</h2>
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">Table mechanics</h2>
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">Odds and fairness</h2>
        <p>
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">Features in this build</h2>
        <ul className="list-disc list-inside space-y-1">
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">A brief history</h2>
        <p>
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">Beta notes</h2>
        <p>
      ...
      <section className="space-y-2 border-l-2 border-amber-200 pl-4">
        <h2 className="font-display text-lg text-amber-700">Credits</h2>
        <ul className="list-disc list-inside space-y-1">
          <li>
